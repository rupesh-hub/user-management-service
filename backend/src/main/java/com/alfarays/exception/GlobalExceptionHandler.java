...
public class GlobalExceptionHandler {
        ...
        exp.getBindingResult()
                ...
                .forEach(error -> {
                    if (error instanceof FieldError) {
                        // Handle FieldError (errors related to specific fields)
                        FieldError fieldError = (FieldError) error;
                        errors.put(fieldError.getField(), error.getDefaultMessage());
                    } else {
                        // Handle ObjectError (global errors not tied to a specific field)
    ...
    public ResponseEntity<ErrorMessage> handleAuthenticationException(
            AuthenticationException exp, HttpServletRequest request) {
        return ResponseEntity
